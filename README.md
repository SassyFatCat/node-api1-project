...
* [ ] Fill out your module retrospective form [here](https://forms.lambdaschool.com/module-retrospective) with a link to your PR
 ...
 npm install -D nodemon     will install a dependency that only runs in development. nodemon restarts the server when changes are made
 'rs' in terminal will manually refresh server